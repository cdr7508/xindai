            ...
            <div class="content">
              ...
              <div class=" bg-fff mb-50">
                <div class="mlr-15">
                    <div class="person-info-head clearfix pdt-15">
                        ...
                        <span class="wait-sp fr" v-if="$route.query.status==='active'"><b class="color-warning">等待我审核</b></span>
                ...
                <router-link :to="{name:'yd_chuzhangjilu',params: {'busiId':$route.query.busiId}}"><p  class="m-15 text-left">
                ...
                <router-link :to="{name:'yd_quanzhengqindan',params: {'busiId':$route.query.busiId,'name':$route.query.cusName}}"><p  class="m-15 text-left">
                    <img src="../assets/business_1.svg" class="pi-img2">
              ...
              <div v-if="$route.query.custType==1">
                ...
                <router-link :to="{name:'yd_seehetong',params: {busiId:$route.query.busiId}}">
                    <p  class="m-15 text-left">
                        <img src="../assets/business_6.svg" class="pi-img2">
                ...
                <router-link :to="{name:'shenpijilu',params: {'objectNo':$route.query.busiId,'modelNo':'microPrint'}}">
                    <p  class="m-15 text-left">
                        <img src="../assets/business_7.svg" class="pi-img2">
                        <span class="ml-15 c-3d fz-16">合同用印审批记录</span>
                        <img src="../assets/next.svg" class="fl-r right-arrow mr5">
                    </p></router-link>
                <div class="bd-line mlr-15"></div>
                <router-link :to="{name:'yd_huankuanqingkuang',params: {busiId:$route.query.busiId}}">
                    <p  class="m-15 text-left">
                        <img src="../assets/business_9.svg" class="pi-img2">
                        <span class="ml-15 c-3d fz-16">还款情况</span>
                        <img src="../assets/next.svg" class="fl-r right-arrow mr5">
                    </p></router-link>
                <div class="bd-line mlr-15"></div>
              <router-link :to="{name:'shenpijilu',params: {'objectNo':$route.query.objectNo,'modelNo':'outStorage'}}">
                <p  class="m-15 text-left">
                  <img src="../assets/business_7.svg" class="pi-img2">
