        ...
        <div class="page page-current">
            ...
            <div class="content">
              ...
              <div class="bg-fff mb-50">
                ...
                <router-link :to="{name:'yd_detail',params: { 'busiId':$route.query.busiId}}"><p  class="m-15 text-left">
                    <img src="../assets/business_1.svg" class="pi-img2">
              ...
              <div v-if="$route.query.custType==1">
                ...
                <div class="bd-line mlr-15"></div>
                <router-link :to="{name:'shenpijilu',params: {'objectNo':$route.query.objectNo,'modelNo':'inStorage'}}">
                    <p  class="m-15 text-left">
