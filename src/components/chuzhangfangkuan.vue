      ...
      <div class="content">
        ...
        <div class="mlr-15">
          <div class="person-info-head clearfix pdt-15">
            <div class="fl"><img src="../assets/task_head.svg" class="mr5"> <span class="uname">{{$route.query.enterName}}</span>
              <span class="c-blue fz-14">（客户：{{$route.query.cusName}}）</span></div>
        ...
        <router-link :to="{name:'yd_chuzhangjilu',params:{'busiId':$route.query.busiId}}">
          <p class="m-15 text-left"><img src="../assets/business_10.svg" class="pi-img2">
            <span class="ml-15 c-3d fz-16">出账记录</span>
            <img src="../assets/next.svg" class="fl-r right-arrow mr5">
          </p>
        </router-link>
        <div class="bd-line mlr-15"></div>
        <router-link :to="{name:'yd_quanzhengqindan',params:{'busiId':$route.query.busiId,'name':$route.query.cusName}}">
          <p class="m-15 text-left"><img src="../assets/business_8.svg" class="pi-img2">
            <span class="ml-15 c-3d fz-16">权证清单</span>
            <img src="../assets/next.svg" class="fl-r right-arrow mr5">
          </p>
        </router-link>
        <div class="bd-line mlr-15"></div>
        <router-link :to="{name:'yd_detail',params: {'busiId':$route.query.busiId}}">
          <p class="m-15 text-left"><img src="../assets/business_1.svg" class="pi-img2">
        ...
        <router-link :to="{name:'yd_danbaocuoshi',params: { 'busiId':$route.query.busiId}}">
          <p class="m-15 text-left"><img src="../assets/business_3.svg" class="pi-img2">
        ...
        <router-link :to="{name:'yd_fujianqindan',params: { 'busiId':$route.query.busiId }}">
          <p class="m-15 text-left"><img src="../assets/business_4.svg" class="pi-img2">
            <span class="ml-15 c-3d fz-16">附件清单</span>
            <img src="../assets/next.svg" class="fl-r right-arrow mr5">
          </p>
        </router-link>
        <div class="bd-line mlr-15"></div>
        <router-link :to="{name:'shenpijilu',params: {'objectNo':$route.query.busiId,'modelNo':'business'}}">
          <p class="m-15 text-left"><img src="../assets/business_5.svg" class="pi-img2">
            <span class="ml-15 c-3d fz-16">贷款审批记录</span>
            <img src="../assets/next.svg" class="fl-r right-arrow mr5">
          </p>
        </router-link>
        <div class="bd-line mlr-15"></div>
        <router-link :to="{name:'yd_seehetong',params:{'busiId':$route.query.busiId}}">
          <p class="m-15 text-left"><img src="../assets/business_6.svg" class="pi-img2">
            <span class="ml-15 c-3d fz-16">查看合同</span>
            <img src="../assets/next.svg" class="fl-r right-arrow mr5">
          </p>
        </router-link>
        <div class="bd-line mlr-15"></div>
          <router-link :to="{name:'shenpijilu',params: {'objectNo':$route.query.busiId,'modelNo':'microPrint'}}">
            <p class="m-15 text-left"><img src="../assets/business_7.svg" class="pi-img2">
              <span class="ml-15 c-3d fz-16">合同用印审批记录</span>
              <img src="../assets/next.svg" class="fl-r right-arrow mr5">
            </p>
          </router-link>
          <div class="bd-line mlr-15"></div>
          <router-link :to="{name:'shenpijilu',params: {'objectNo':$route.query.objectNo,'modelNo':'outOfAccount'}}">
            <p class="m-15 text-left"><img src="../assets/business_7.svg" class="pi-img2">
