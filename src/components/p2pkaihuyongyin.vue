      ...
      <div class="content">
        ...
        <div class="mlr-15">
          <div class="person-info-head clearfix pdt-15">
            <div class="fl"><img src="../assets/task_head.svg" class="mr5"> <span class="uname">{{$route.query.enterName}}</span> <span class="c-blue fz-14">（客户：{{$route.query.title}}）</span></div>
        ...
        <div>
          <router-link :to="{name:'yd_kehuziliao_qy',params: { 'custId':$route.query.objectNo }}">
        ...
        <router-link :to="{name:'yd_fujianqindan_p2p',params: { 'objectNo':$route.query.objectNo,'nodeno':$route.query.nodeno,'modelNo':$route.query.modelNo,'status':$route.query.status}}">
          <p class="m-15 text-left"><img src="../assets/business_4.svg" class="pi-img2">
            <span class="ml-15 c-3d fz-16">开户材料</span>
            <img src="../assets/next.svg" class="fl-r right-arrow mr5">
          </p>
        </router-link>
        <div class="bd-line mlr-15"></div>
