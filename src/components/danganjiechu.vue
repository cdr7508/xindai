        ...
        <div class="page page-current">
            ...
            <div class="content">
              ...
              <div class="bg-fff mb-50">
                ...
                <!--<div class="bgf" style="padding-top:.45rem ;padding-bottom: .5rem;">-->
                  <router-link :to="{name:'yd_danganjiechuxq',params:{'objectNo':$route.query.objectNo}}">
                        <p class="m-15 text-left ">
                            <img src="../assets/business_17.svg" class="pi-img2">
                            <span class="ml-15 c-3d fz-16">档案借出详情</span>
                  ...
                  <div class="bd-line mlr-15"></div>
                  <router-link :to="{name:'shenpijilu',params: {'objectNo':$route.query.objectNo,'modelNo':'lender'}}">
                    <p class="m-15 text-left">
                      <img src="../assets/business_18.svg" class="pi-img2">
